...
import { deleteOrganizations } from '@/db/actions/organizations';
import type { RecordsOrganization } from '@/db/schema';
import { useMediaQuery } from '@/hooks/use-media-query';

interface DeleteOrganizationsDialogProps
  extends React.ComponentPropsWithoutRef<typeof Dialog> {
  organizations: Row<RecordsOrganization>['original'][];
  showTrigger?: boolean;
  onSuccess?: () => void;
  name: string;
}
...
export function DeleteOrganizationsDialog({
  ...
  function onDelete() {
    startDeleteTransition(async () => {
      const { error } = await deleteOrganizations({
